...
zip_statement: IDENTIFIER ASSIGN ZIP LPAR IDENTIFIER COMMA IDENTIFIER RPAR
{
   ...
   int r_e1 = loadArrayElement(program, $5, create_expression(r_x, REGISTER));
   int r_e2 = loadArrayElement(program, $7, create_expression(r_x, REGISTER));

   storeArrayElement(program, $1, create_expression(r_i, REGISTER), create_expression(r_e1, REGISTER));
   ...
   storeArrayElement(program, $1, create_expression(r_i, REGISTER), create_expression(r_e2, REGISTER));
